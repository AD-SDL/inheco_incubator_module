...
This example assumes there are two incubator devices in one stack. Please edit to suit your needs.
"""
...
print("Opening connection to the incubator device stack over the COM port.")
...
print("Reporting actual temperature.")
...
print("Reporting target temperature.")
...
print("Is the heater active? (Heater on both devices should be off.)")
print(f"Stack floor 0: {device_stack.is_heater_active(stack_floor=0)}")
print(f"Stack floor 1: {device_stack.is_heater_active(stack_floor=1)}")
...
print("Is the door open? (Door should be closed on both devices.)")
...
print("Is the shaker active? (Shaker on both devices should be off.)")
